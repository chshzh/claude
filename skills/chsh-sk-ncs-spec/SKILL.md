...
# chsh-sk-ncs-spec — Technical Design Workflow
...
between design (this skill) and implementation (`chsh-sk-ncs-project`).
...
> "No PRD found at `docs/pm-prd/PRD.md`. Please run **chsh-sk-ncs-prd** first."
...
3. Remind the user:
   > "Specs are ready. Run **chsh-sk-ncs-project** to scaffold the project and implement the code."
...
> "Specs updated. Review the changes, then run **chsh-sk-ncs-project** to update the implementation."
...
Use this checklist before handing off specs to `chsh-sk-ncs-project`.
