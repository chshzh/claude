...
# chsh-sk-ncs-workflow — NCS Project Lifecycle Orchestrator
...
```
┌────────────────────────────────────────────────────────────────┐
│  PHASE 1 — PRODUCT DEFINITION         skill: chsh-sk-ncs-prd       │
│                                                                 │
...
└───────────────────────────┬────────────────────────────────────┘
                            ...
                            ▼
┌────────────────────────────────────────────────────────────────┐
│  PHASE 2 — TECHNICAL DESIGN           skill: chsh-sk-ncs-spec     │
│                                                                 │
...
└───────────────────────────┬────────────────────────────────────┘
                            ...
                            ▼
┌────────────────────────────────────────────────────────────────┐
│  PHASE 3 — IMPLEMENTATION             skill: chsh-sk-ncs-project  │
│                                                                 │
...
└───────────────────────────┬────────────────────────────────────┘
                            ...
                            ▼
┌────────────────────────────────────────────────────────────────┐
│  PHASE 4 — QA & FUNCTIONAL TEST       skill: chsh-sk-ncs-test    │
│                                                                 │
│  Test Report (always):                                         │
...
**Run:** Load skill **chsh-sk-ncs-prd** and follow its workflow.

**Output:** `docs/pm-prd/PRD.md` with new Changelog entry

**On completion**, ask:
> "PRD is updated. Proceed to **Phase 2 — Specs** with chsh-sk-ncs-spec? (yes / stop)"
...
**Run:** Load skill **chsh-sk-ncs-spec** and follow its workflow.
...
**On completion**, ask:
> "Specs are ready. Proceed to **Phase 3 — Implementation** with chsh-sk-ncs-project? (yes / stop)"
...
**Run:** Load skill **chsh-sk-ncs-project** and follow its workflow.
...
**On completion**, ask:
> "Implementation done. Proceed to **Phase 4 — QA & Test** with chsh-sk-ncs-test? (yes / stop)"

---

## Phase 4 — QA & Test  `skill: chsh-sk-ncs-test`
...
**Run:** Load skill **chsh-sk-ncs-test** and follow its workflow.
...
|-------|-------------|--------|
| `chsh-sk-ncs-workflow` | **Starting any project work** | Status dashboard + phase guidance |
...
| `chsh-sk-ncs-memory` | Diagnosing memory usage | Heap / stack recommendations |
