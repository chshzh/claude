---
name: chsh-sk-ncs-project-architecture
...
```bash
cp ~/.claude/skills/chsh-sk-ncs-project/architecture/simple-multithreaded/templates/* src/
cp ~/.claude/skills/chsh-sk-ncs-prd/overlays/overlay-multithreaded.conf .
```
...
cp -r ~/.claude/skills/chsh-sk-ncs-project/architecture/smf-zbus/modules/button_example src/modules/button
cp -r ~/.claude/skills/chsh-sk-ncs-project/architecture/smf-zbus/modules/sensor_example src/modules/sensor
cp -r ~/.claude/skills/chsh-sk-ncs-project/architecture/smf-zbus/modules/data_processor_example src/modules/data_processor

# Copy common message definitions
cp ~/.claude/skills/chsh-sk-ncs-project/architecture/smf-zbus/modules/common/messages.h src/modules/

# Copy configuration overlay
cp ~/.claude/skills/chsh-sk-ncs-prd/overlays/overlay-smf-zbus.conf .
```
